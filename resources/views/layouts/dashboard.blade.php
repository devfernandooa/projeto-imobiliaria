...
{{-- Sidebar (Menu Lateral) --}}
<div class=" offcanvas-start bg-dark text-white sidebar-nav" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
    ...
    <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
            <ul class="navbar-nav">
                ...
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#usuariosCollapse" role="button" aria-expanded="false" aria-controls="usuariosCollapse">
                        <i class="fas fa-users me-2"></i> Gerenciar Usuários
                        <span class="right-icon ms-auto"><i class="fas fa-chevron-down"></i></span> {{-- Ícone de seta --}}
                    </a>
                    <div class="collapse" id="usuariosCollapse">
                        <ul class="navbar-nav ps-3"> {{-- ps-3 para padding-left, indentação do sub-menu --}}
                            <li>
                            ...
                            {{-- Adicione mais links aqui para Editar, Visualizar, etc. futuramente --}}
                        </ul>
                    </div>
                </li>

                {{-- SUB-MENU: Gerenciar Imobiliárias --}}
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#imobiliariasCollapse" role="button" aria-expanded="false" aria-controls="imobiliariasCollapse">
                ...
                {{-- SUB-MENU: Gerenciar Endereços --}}
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#enderecosCollapse" role="button" aria-expanded="false" aria-controls="enderecosCollapse">
                ...
                {{-- SUB-MENU: Gerenciar Imóveis (Placeholder) --}}
                <li>
                    <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#imoveisCollapse" role="button" aria-expanded="false" aria-controls="imoveisCollapse">
